...
package com.oracle.cch.swingtest.Repositories.impl;
...
public class ProductRepositoryImpl implements Serializable, ProductRepository {
    ...
    public ProductRepositoryImpl(String db){
        this.emf=javax.persistence.Persistence.createEntityManagerFactory(db);
    }
